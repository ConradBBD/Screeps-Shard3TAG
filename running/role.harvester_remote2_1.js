var roleHarvesterRemote2_1 = {

    /** @param {Creep} creep **/
    run: function(creep) {

        if (creep.room.name == 'E36N52') {
            const targetPos = new RoomPosition(18, 48, 'E37N52');
        ...
        if (creep.room.name == 'E37N52') {
            ...
            if (!creep.memory.inPosition) {
                ...
                const targetPos = new RoomPosition(15, 21, 'E37N51');
                creep.moveTo(targetPos, {visualizePathStyle: {stroke: '#ffffff'}});
            }
        }
...
module.exports = roleHarvesterRemote2_1;